...
if __name__=='__main__':
    ...
    parser.add_argument('--our_model_path', type=str, 
                        default='models/hierarchy_discovery/models/hierarchy_discovery/res101_hierarchy_discovery_run1/net_epoch20.pth')
    ...
    parser.add_argument('--eval_cache_path', type=str, default='eval_classification_cache/ablations')
    ...
    DF_clip = EK_Dataset_discovery(test_knowns, test_unknowns,
                ...
                snip_threshold=24,
                use_resnet101=True) # changed to 24 to guard against crashes
