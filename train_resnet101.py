...
if __name__ == '__main__':
    ...
    model_saveloc = os.path.join(args.model_folder, 'res101_hierarchy_discovery_run{}'.format(args.run_num))

    model = Resnet101VanillaEnd2End(frame_feat_shape= (1024, 1), tree_embedding_dim = 2048, handpose_dim = 126,
             handbbox_dim = 8, action_embedding_dim=100, timesteps=time_normalized_dimension, device=DEVICE)
